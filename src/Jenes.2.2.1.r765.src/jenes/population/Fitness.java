 ...
 * <p>
 * Socring of individuals is obtained by implementing the abstract method <code>evaluate</code>.
...
public abstract class Fitness<C extends Chromosome> implements Cloneable {
     ...
     * lenght of array given as argument. Each cell of array represent a flag 
    ...
    /**
     * Prepares the evaluation. Callback used to prepare the evaluation. It can
     * be overridden to provide a specific task.
     * <p>
    ...
    /**
     * Adjust the evaluation after elistim is applied. Callback used to adjust 
     * the scores after the elitism is applied. It can be overridden to provide
     * a specific task.
     * <p>
     * @param pop    population to evaluate.
     * @param elite  individuals entered because of elitism
     */
    public void adjust(Population<C> pop, Individual<C>[] elite) {
        // INTENTIONALLY EMPTY        
    }
