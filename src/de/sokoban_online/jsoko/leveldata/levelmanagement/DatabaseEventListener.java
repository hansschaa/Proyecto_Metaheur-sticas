...
/**
 * Interface for listeners of {@code DatabaseDataEvent}s.
 */
public interface DatabaseEventListener extends EventListener {

	/**
	 * Called when the database data have been changed.
	 *
	 * @param event <code>DatabaseDataEvent</code> encapsulating the
     *    event information
	 */
