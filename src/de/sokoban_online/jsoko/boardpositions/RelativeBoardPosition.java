...
public class RelativeBoardPosition extends BoardPosition implements Cloneable {
	 ...
	 * @param precedingBoardPosition the preceding board position
	 */
	final public void setPrecedingBoardPosition(IBoardPosition precedingBoardPosition) {
		this.precedingBoardPosition = precedingBoardPosition;
	}
	 ...
	 */
	@Override
	final public SearchDirection getSearchDirection() {
		...
		switch(directionValue) {
			...
			case 3:
				return SearchDirection.BACKWARD_GOAL_ROOM;
		}
	...
	public int getPushesCount() {
		...
		for (BoardPosition currentBoardPosition = this;
             currentBoardPosition.getPrecedingBoardPosition() != null; 
             currentBoardPosition = (BoardPosition) currentBoardPosition.getPrecedingBoardPosition()) {
