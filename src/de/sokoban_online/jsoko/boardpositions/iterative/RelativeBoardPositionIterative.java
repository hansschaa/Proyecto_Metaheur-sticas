 ...
 * <li> are used in a search for a solution (-> "RelativeSEARCHBoardPositionIterative)
 * <li> store the box and player positions relative to the previous board position
 * <li> are used in an iterative search (-> "RelativeSearchBoardPositionITERATIVE")
 * </ul>
 */
public final class RelativeBoardPositionIterative extends RelativeBoardPosition
	 ...
	 */
	public RelativeBoardPositionIterative(Board board,
