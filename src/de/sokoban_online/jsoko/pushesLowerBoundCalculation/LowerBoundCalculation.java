...
public class LowerBoundCalculation {
	...
	public int calculatePushesLowerBound(int newBoxPosition) {
		...
		int pushesLowerbound = minimumMatching.calculatePushesLowerBound(SearchDirection.FORWARD);
	 ...
	 * If a deadlock is recognized, we return {@link LowerBoundCalculation#DEADLOCK}.
	 *
	...
	public int calculatePushesLowerboundBackwardsSearch(int newBoxPosition) {
		...
		return minimumMatching.calculatePushesLowerBound(SearchDirection.BACKWARD);
	}
}
