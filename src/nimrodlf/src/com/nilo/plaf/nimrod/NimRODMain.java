...
public class NimRODMain extends JFrame {
  ...
  public NimRODMain() {  //Made public - Matthias Meger
  ...
  private void hazConfig() {
    ...
    lFont = new JLabel( "Choose a new font..."); //Translated to English     Matthias Meger
  ...
  private void hazPreview1() {
    ...
    b.addActionListener(ev -> JOptionPane.showMessageDialog( NimRODMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.ERROR_MESSAGE));
    bots.add( b);
    
    b = new JButton( UIManager.getIcon( "OptionPane.informationIcon"));
    b.addActionListener(ev -> JOptionPane.showMessageDialog( NimRODMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.INFORMATION_MESSAGE));
    bots.add( b);
    
    b = new JButton( UIManager.getIcon( "OptionPane.warningIcon"));
    b.addActionListener(ev -> JOptionPane.showMessageDialog( NimRODMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.WARNING_MESSAGE));
    bots.add( b);
    
    b = new JButton( UIManager.getIcon( "OptionPane.questionIcon"));
    b.addActionListener(ev -> JOptionPane.showMessageDialog( NimRODMain.this, "Eggs aren't supposed to be green.", "Inane warning", JOptionPane.QUESTION_MESSAGE));
    bots.add( b);
  ...
  int index = 0;
  final ImageIcon[] lIcon = { NimRODUtils.loadRes( "/com/nilo/plaf/nimrod/icons/tools.png"),
